export const templates = [
  ...
  },
  {
    ...
    initialContent: `
			...
			<h2>Scope of work</h2>
			<p>Deatiled breakdown of project deliverables and requirements.</p>
			
			<h2>Timeline</h2>
			<p>Project milestones and delivery schedule.</p>

			<h2>Budget</h2>
			<p>Estimated cost and budget breakdown.</p>
		`,
  },
  {
    id: 'project-proposal',
  ...
  },
  {
    ...
    initialContent: `
			...
			<h2>Education</h2>
			<p>[Degree] - [Instituation] <br> [Graduation Year]</p>
  ...
  },
  {
    ...
    initialContent: `
			<h1>Cover Letter</h1>
			<p>This is a cover letter template.</p>
		`,
  },
  {
    id: 'letter',
